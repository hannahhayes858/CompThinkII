...
For our for loop we want it to read the species column from penguins and return the unique species names in a vector. The for loop is going to iterate the across the species names in the vector giving us a unique plot for each species.
